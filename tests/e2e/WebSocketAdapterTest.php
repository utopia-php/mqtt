 ...
 * (tests/servers/Swoole, WebSocket port 9001): the same CONNECT/CONNACK, SUBSCRIBE/SUBACK and
 * PING exchange as the raw-TCP AdapterTest, but each MQTT packet rides in a WebSocket binary
 * frame, proving the adapter's WebSocket listener, packet reassembly, and framed send.
 */
